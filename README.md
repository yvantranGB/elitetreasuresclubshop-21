...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/ytran-21)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/ytran-21
```

A live public deployment of this template is available at [https://ytran-21.templates.workers.dev](https://ytran-21.templates.workers.dev)
